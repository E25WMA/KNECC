                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={6}>
                            <Select
                                ...
                                variant="outlined"
                            >
                                <MenuItem value="ห้องว่าง" sx={{ color: 'green', fontWeight: 'bold' }}>ห้องว่าง</MenuItem>
                                <MenuItem value="มีผู้จองแล้ว" sx={{ color: 'red', fontWeight: 'bold' }}>มีผู้จองแล้ว</MenuItem>
