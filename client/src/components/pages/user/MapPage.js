...
const MapPage = () => {
    ...
    return (
        <div style={{ height: "calc(100vh - 64px)", width: "100%" }}> {/* ใช้ calc เพื่อลบความสูงของ AppBar */}
            <MapContainer center={[16.74834, 100.18674]} zoom={15} style={{ height: "100%", width: "100%" }}>
                <TileLayer
                    url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
                    attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
                />
                <Marker position={[16.74834, 100.18674]}>
                    <Popup>
                        <img
                            src="/assets/KNECC11.jpg"
                            style={{ width: "100%", height: "auto", marginBottom: "10px" }}
                        />
                        <strong>KNECC</strong><br />
                        <button
